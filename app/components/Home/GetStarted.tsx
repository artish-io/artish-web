    ...
    <div className="bg-[#FCFBFC]">
      <div className="container">
          ...
          <div className="flex gap-10 justify-between items-center flex-col md:flex-row-reverse">
            <div className="basis-1/2">
              ...
              <p className="text-[#130E01] leading-relaxed text-base md:text-lg">
                ...
                freedom, or you want to manage production of creative work
                without stress, ARTISH provides a trust-led enviroment to bring
                you a truly visionary experience of the future of work.{" "}
                <Link href="#" className="text-[#B30445] underline">
                  Learn More
                </Link>
                .
        ...
        <section className="py-18 md:py-26">
          <div className="w-full lg:w-1/2 mx-auto space-y-6 text-center">
            <h2 className="text-3xl md:text-4xl font-semibold leading-tight">
            ...
            <div className="flex items-center gap-5 justify-center">
              <Link
                href="mailto:contact@artish.world"
