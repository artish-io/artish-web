			...
			<section className="my-28 md:my-36">
				<div className="w-full md:w-1/2 mx-auto space-y-6 text-center">
					...
					<div className="flex items-center gap-5 justify-center">
						<Link
							href="/login"
							className="font-semibold rounded-md border-2 border-black py-3 px-2 md:px-6 bg-black text-white inline-flex gap-4 items-center"
						>
							Join as a Freelancer
						</Link>
						<Link
							href="/login"
							className="font-semibold rounded-md border-2 border-black py-3 px-2 md:px-6 bg-white text-black inline-flex gap-4 items-center"
						>
